...
$ALWAYS_HTTPS = true;
define("PROXY_PREFIX", "http" . (isset($_SERVER['HTTPS']) || $ALWAYS_HTTPS ? "s" : "") . "://" . $_SERVER["SERVER_NAME"] . ($_SERVER["SERVER_PORT"] != 80 ? ":" . $_SERVER["SERVER_PORT"] : "") . $_SERVER["SCRIPT_NAME"] . "/");
